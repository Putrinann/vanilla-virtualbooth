    ...
    <main className="paper-shell relative min-h-screen overflow-hidden px-2 py-2 text-ink sm:px-3">
      ...
      {exportedImage && (
        <div className="fixed inset-0 z-50 grid place-items-center bg-ink/80 p-4">
          <div className="export-preview-card max-h-[92vh] w-full max-w-sm rounded-3xl border-4 border-ink bg-white p-3 shadow-[8px_8px_0_#171321]">
            <img src={exportedImage} alt="Final Vanilla Booth export" className="export-preview-image max-h-[70vh] w-full object-contain" />
